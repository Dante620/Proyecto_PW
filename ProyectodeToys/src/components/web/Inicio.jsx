    ...
    return (
        <>
            <header id="main-header">
                ...
                <ul id="menu">
                    <li class="menu-item">📁 CATEGORÍAS</li>
                    <li class="menu-item">🔜 PRE-VENTA</li>
            ...
            <div class="banner-section">
                <ul>
                    <li><img src="../../imagenes/Arriba/Imagen2.jpg" alt="Banner 1"></img></li>
                    <li><img src="../../imagenes/Arriba/Imagen4.jpg" alt="Banner 2"></img></li>
                </ul>
            </div>
